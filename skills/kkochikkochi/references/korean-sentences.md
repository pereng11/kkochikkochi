<!--
출처: im-not-ai — https://github.com/epoko77-ai/im-not-ai
      .claude/skills/humanize-korean/references/quick-rules.md
라이선스: MIT · Copyright (c) 2026 epoko77-ai
가져온 판: Quick Rules v2.0 · 가져온 날짜: 2026-07-30

이 파일은 상류의 사본이다. 손으로 고치지 말고, 상류가 갱신되면 통째로 다시
가져온 뒤 위 날짜를 고친다. 이 도구에서 특히 자주 걸리는 항목은 SKILL.md §2
의 표에 추려 두었다 — 게이트가 걸릴 때마다 읽히는 것은 그 표이고, 이 파일은
표로 부족할 때만 읽는다.
-->
